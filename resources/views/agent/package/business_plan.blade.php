              ...
              <div class="card-body">
                <div class="container-fluid d-flex justify-content-between">
                  <div class="col-lg-3 ps-0">
                    <a href="#" class="noble-ui-logo logo-light d-block mt-3">Amar<span>Bari</span></a>                 
                    <p class="mt-1 mb-1"><b>Shahjadpur</b></p>
                    <p>108,<br> West Wind Point,<br>Dhaka, Bangladesh.</p>
                  ...
                  <div class="col-lg-3 pe-0">
                    ...
                    <h4 class="text-end fw-normal">TK 2000</h4>
                        ...
                        <div class="table-responsive">
                          <table class="table">
                              <tbody>
                                <tr>
                                  <td>Sub Total</td>
                                  <td class="text-end">TK 2000</td>
                                </tr>
                                <tr>
                                  <td class="text-bold-800">Total</td>
                                  <td class="text-bold-800 text-end"> TK 2000</td>
                                </tr>
                                <tr>
                                  <td>Payment Made</td>
                                  <td class="text-danger text-end">(-)  TK 2000</td>
                                </tr>
                                <tr class="bg-dark">
